...
<head>
    ...
    <title>Welcome to Stock-Watcher</title>
    <!--[if mso]>
    <noscript>
        <xml>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <img src="https://github.com/shubhamkumar200328/stock-watcher/blob/main/public/assets/images/logo.png?raw=true" alt="stock-watcher Logo" width="150" style="max-width: 100%; height: auto;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" class="dashboard-preview" style="padding: 40px 40px 0px 40px;">
                            <img src="https://github.com/shubhamkumar200328/stock-watcher/blob/main/public/assets/images/dasboard_ss.png?raw=true" alt="Stock-Watcher Dashboard Preview" width="100%" style="max-width: 520px; width: 100%; height: auto; border-radius: 12px; border: 1px solid #30333A;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-muted" style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important; text-align: center;">
                               Stock-Watcher main brach Jaipur, Malviya Nagar<br>
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Visit Stock-Watcher</a><br>
                                © 2025 Stock-watcher
                            </p>
                        </td>
                    </tr>
